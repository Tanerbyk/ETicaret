...
namespace ETicaret.Shared.Dal.Migrations
{
    ...
    [Migration("20230425010332_mg2312231")]
    partial class mg2312231
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETicaret.Shared.Dal.Concrete.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ETicaret.Shared.Dal.Concrete.OrderDetail", b =>
                {
                    b.HasOne("ETicaret.Shared.Dal.Concrete.Order", null)
            ...
            modelBuilder.Entity("ETicaret.Shared.Dal.Concrete.User", b =>
                {
                    b.HasOne("ETicaret.Shared.Dal.Concrete.Order", "Order")
                        .WithMany()
                        .HasForeignKey("OrderId");
